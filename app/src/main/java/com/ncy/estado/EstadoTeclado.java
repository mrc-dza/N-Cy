...
public class EstadoTeclado {
    ...
    private final SparseBooleanArray modificadoresActivos = new SparseBooleanArray();
    ...
    public boolean isModificadorActivo(int codigoModificador) {
        ...
        return modificadoresActivos.get(codigoModificador, false);
    }
    public void alternarModificador(int codigoModificador) {
        if (modificadoresActivos.get(codigoModificador, false)) {
            modificadoresActivos.delete(codigoModificador);
        } else {
            modificadoresActivos.put(codigoModificador, true);
        }
    }
