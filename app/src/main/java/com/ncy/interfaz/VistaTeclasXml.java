...
public class VistaTeclasXml extends View {
    ...
    public VistaTeclasXml(Context contexto, ManejadorEntrada manejador,
                          ...
                          int filaDesde, int filaHasta, GestorTema gestorTema) {
        super(contexto);
        ...
        this.controladorToque = new ControladorToqueXml(contexto, this, manejador, estado, layout, controladorBarra, filaDesde, filaHasta, gestorTema);

        setBackgroundColor(temaActual.getColorFondoGeneral());
    }

    public VistaTeclasXml(Context contexto, ManejadorEntrada manejador,
                          EstadoTeclado estado, LayoutTeclado layout, GestorTema gestorTema) {
        this(contexto, manejador, estado, layout, -1, -1, gestorTema);
    }
    ...
    public void aplicarTema(TemaVisual tema) {
        ...
        if (dibujante != null) dibujante.actualizarTema(tema);
