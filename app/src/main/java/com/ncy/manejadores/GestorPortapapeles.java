...
public class GestorPortapapeles {
    ...
    public void destruir() {
        if (ejecutorFondo != null && !ejecutorFondo.isShutdown()) {
            ...
            try {
                // Espera máximo 2 segundos a que termine la escritura en curso
                if (!ejecutorFondo.awaitTermination(2, java.util.concurrent.TimeUnit.SECONDS)) {
                    ejecutorFondo.shutdownNow();
                }
